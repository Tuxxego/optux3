"Scheme"
{
	"BaseSettings"
	{
		...
		"Panel.Button.Height.Out"						"0"
		"Panel.Button.Height.Over"						"0"
		...
		"Panel.Button.Description.Hide.Over"			"1"
		"Panel.Button.Description.Hide.Pressed"			"1"
		"Panel.Button.Description.Hide.Released"		"1"

		"Panel.Button.Background.Blur.Out"				"1"
		"Panel.Button.Background.Blur.Over"				"1"
		"Panel.Button.Background.Blur.Pressed"			"1"
		"Panel.Button.Background.Blur.Released"			"1"

		"Panel.Button.Animation.Width"					"1"
		"Panel.Button.Animation.Height"					"1"
		"Panel.Button.Animation.Background"				"1"
		"Panel.Button.Animation.Text"					"1"
		"Panel.Button.Animation.Description"			"1"
	}

	"Colors"
	{
		"Panel.Background.Gradient.Top"					"0 0 0 0"
		"Panel.Background.Gradient.Bottom"				"0 0 0 0"
